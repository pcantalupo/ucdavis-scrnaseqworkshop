...
View(experiment.aggregate@reductions$pca)
hvg=VariableFeatures(experiment.aggregate)
grep("S100b", hvg)

fl= experiment.aggregate@reductions$pca@feature.loadings
dim(fl)
fl["S100b",c(1:5)]
ce = experiment.aggregate@reductions$pca@cell.embeddings
dim(ce)
ce[c(1:5),"PC_1"]
```
